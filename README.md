...
**너야**는 대한민국 고등학생·재수생을 위한 **수능 학습자료 배포 시스템**입니다. 사회탐구·과학탐구·한국사 등 19개 과목의 문제집·정답지를 구글 드라이브와 연동하여 실시간으로 배포합니다.
...
### 컬러 시스템 (너야 SSoT · NEOYA Design System 정본)

| 이름 | HEX | 용도 |
|------|------|------|
| 딥 블루 | `#1A3A5C` | 주요 타이포·심볼·신뢰의 축 |
| 미드 블루 | `#2B5F8B` | 서브 타이포·표 강조·그라디언트 종점 |
| 스카이 블루 | `#5A8CB5` | 로고 파도 중간 라인·보조 강조 |
| 라이트 웨이브 | `#A8C4DD` | 파도 라인·구분선·잔물결 레이어 |
| 폼 화이트 | `#F5F9FC` | 섹션 배경·인용구 |
...
> 물고기를 잡아서 주지 않습니다. 잡는 사람은 — 너야.
> 강의는 누구나 들을 수 있습니다. 배운 것을 내 것으로 잡아 두는 사람은 학습자 자신입니다.
> 너야는 그 사람을 문장의 주어로 세우는 이름입니다.

### 이름의 흐름 — 너울에서 너야로

이 서비스는 2026년 4월 「너울」(바다의 크고 넓은 파도)이라는 이름으로 시작했고, 2026년 9월 24일 「너야(NEOYA)」로 이름을 바꿨습니다. 첫 음절 「너」와 웨이브 라인·딥 블루 색은 그대로 이어받았고, 로고에는 파도 위에 점 하나를 더했습니다 — 큰 파도를 뜻하던 이름에서, 그 파도를 타는 사람을 부르는 이름으로. 영문 **NEOYA**의 **NEO**는 '새로움'을 뜻합니다.
...
- 지정 상품·서비스는 변리사 검토를 거쳐 출원 시 확정합니다.
...
| 버전 | 날짜 | 변경 내용 |
|------|------|----------|
| 1.0.0 | 2026-04-24 | **너울 브랜드 공식 런칭**(2026-09-24 너야(NEOYA)로 명칭 변경). 교육자료 배포 시스템 v1 공개. 저작권자 김태민 명시. 상표 출원번호 TN26005859KJ 명시. 배포 학습자료는 김태민 본인 출제 교육 저작물임을 명시. |
